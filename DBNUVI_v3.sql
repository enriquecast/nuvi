...
detalleProblematica varchar (45)
);
...
numContactoProveedor VARCHAR (45),
direccionProveedor VARCHAR(45)
);

CREATE TABLE COTIZACIONES(
idCotizacion INT PRIMARY KEY AUTO_INCREMENT,
numCotizacion varchar(45),
fechaCotizacion date,
fkProyecto INT,
imgCotizacion varchar (200),
FOREIGN KEY (fkProyecto) REFERENCES PROYECTOS (idProyecto)
);

CREATE TABLE COTIZACIONES_PROVEEDORES(
idCotizacionProveedor INT PRIMARY KEY AUTO_INCREMENT,
fkCotizacion INT,
fkProveedor INT,
detalle varchar (45),
FOREIGN KEY (fkCotizacion) REFERENCES COTIZACIONES (idCotizacion),
FOREIGN KEY (fkProveedor) REFERENCES PROVEEDORES (idProveedores)
);

CREATE TABLE MATERIALES_COTIZACIONES(
